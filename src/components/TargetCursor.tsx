...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  const changeCursorColor = useCallback((color: string) => {
    if (!cursorRef.current) return;
    
    // Zmień kolor wszystkich rogów
    const corners = cursorRef.current.querySelectorAll('.target-cursor-corner');
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      // Usuwam zmianę koloru - cursor pozostaje biały
      ...
      const leaveHandler = () => {
        ...
        // Usuwam przywracanie koloru - cursor pozostaje biały
